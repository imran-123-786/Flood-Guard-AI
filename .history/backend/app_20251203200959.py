...
# ============================================================
# 📰 NEWS API ENDPOINT (PROXY + Secure Key)
# ============================================================

@app.route("/api/news", methods=["GET"])
def get_news():
    lang = request.args.get("lang", "en")
    url = f"https://newsdata.io/api/1/news?apikey={os.getenv('NEWSDATA_API_KEY')}&country=in&language={lang}&category=top,weather,disaster,environment"
