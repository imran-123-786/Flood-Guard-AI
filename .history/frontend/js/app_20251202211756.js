...
<head>
    ...
    <title>Flood Guard – Official Flood Safety System</title>
...
<header>
    <div class="app-title">🌊 Flood Guard</div>
    <div class="top-nav">
        <div class="nav-menu">
...
<main>
    ...
    <section id="dashboard" class="section active">
        ...
        <div class="status-cards">
            <div class="card"><strong>Temperature</strong><p id="temp">--°C</p></div>
    ...
    <section id="account" class="section">
        ...
        <ul>
            <li>✔ Offline emergency backup</li>
            <li>✔ Government-ready system</li>
            <li>✔ GPS-based shelters & emergency tools</li>
        </ul>
        ...
        <details><summary>Does it work offline?</summary><p>Yes — SOS, reports & cached data still work.</p></details>
        <details><summary>Is data private?</summary><p>Your device stores data. Nothing is uploaded.</p></details>
        <details><summary>Can I use outside India?</summary><p>Yes — but Indian shelters are optimized.</p></details>
...
<footer>
    <p>© 2025 Flood Guard | Emergency Safety System</p>
</footer>
